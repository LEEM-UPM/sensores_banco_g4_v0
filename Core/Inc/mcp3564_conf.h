...
#define MCP3561_USERCONF_IRQ_REG (MCP3561_IRQ_MODE_MDAT_HIGH | MCP3561_IRQ_FASTCMD_ON | MCP3561_IRQ_STP_OFF)
...
#define MCP3561_USERCONF_IRQ_REG (MCP3561_IRQ_MODE_MDAT_HIGH | MCP3561_IRQ_FASTCMD_ON | MCP3561_IRQ_STP_ON)
#define MCP3561_USERCONF_SCAN_ENABLE // enable / disable SCAN conversion mode
 ...
 */
#define MCP3561_USERCONF_SCAN_REG (MCP3561_SCAN_DLY_8   | \
                                   MCP3561_SCAN_CH_DIFF_A | \
                                   MCP3561_SCAN_CH_DIFF_B | \
                                   MCP3561_SCAN_CH_DIFF_C | \
                                   MCP3561_SCAN_CH_DIFF_D)
#define MCP3561_USERCONF_TIMER_VAL (1000)
